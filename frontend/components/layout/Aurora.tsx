...
/**
 * Aurora — WebGL animated gradient backdrop, ported from React Bits.
 * Renders a noise-driven aurora curtain into a full-bleed <canvas>.
 *
 * Usage:
 *   <Aurora
...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    // ogl's Triangle helper adds a uv attribute the shader doesn't declare;
    // strip it so WebGL doesn't warn about an unused attribute slot.
