...
/**
 * VariableProximity — ported from React Bits.
 *
 * Letters interpolate their font-variation-settings ('wght', 'opsz', …) based
 * on the cursor's distance to each letter. Uses Roboto Flex (loaded via the
 * companion CSS file) so the variable axes are available.
 *
 * Only difference from the source: imports motion from `framer-motion`
 * (already in our deps) instead of `motion/react`. Same API.
 */
